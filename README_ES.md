...
- **Integrity**: SHA-256, metadata de conversión, timestamps UTC
...
Documentación completa: [`docs/es/12_docker_quickstart.md`](docs/es/12_docker_quickstart.md)
...
Documentación completa: [`docs/es/06_guia_de_configuracion.md`](docs/es/06_guia_de_configuracion.md)
...
Documentación completa: [`docs/es/03_arquitectura_tecnica.md`](docs/es/03_arquitectura_tecnica.md)
...
Documentación: [`docs/es/11_tests.md`](docs/es/11_tests.md)

## Documentación

### Documentación Técnica (`docs/`)
- [`00_indice.md`](docs/es/00_indice.md) - Índice de documentación
- [`01_instalacion_y_configuracion.md`](docs/es/01_instalacion_y_configuracion.md) - Setup detallado
- [`02_chain_of_custody.md`](docs/es/02_chain_of_custody.md) - Integridad forense y chain of custody
- [`03_arquitectura_tecnica.md`](docs/es/03_arquitectura_tecnica.md) - Diseño del sistema
- [`06_guia_de_configuracion.md`](docs/es/06_guia_de_configuracion.md) - Referencia de configuración
- [`10_troubleshooting.md`](docs/es/10_troubleshooting.md) - Resolución de problemas comunes
- [`11_tests.md`](docs/es/11_tests.md) - Ejecución de tests
- [`12_docker_quickstart.md`](docs/es/12_docker_quickstart.md) - Deployment con Docker
...
Las contribuciones son bienvenidas. Por favor lee `CONTRIBUTING_ES.md` para detalles sobre nuestro código de conducta y proceso de pull requests.
...
- Documentación completa: [`docs/es/00_indice.md`](docs/es/00_indice.md)
